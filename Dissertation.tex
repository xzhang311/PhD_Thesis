...
The proposed approach has been used in many object recognition problems in my research. The results can be found in \cite{Zhang2014Autoencoder}\cite{AndiZang2015}\cite{ZX:14}.
...
The proposed neural network is trained 600 epoches. trained network is applied on validation set given description of validation set. Some synthesized images are shown below. 
